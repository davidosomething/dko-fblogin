...
if (array_key_exists('error', $_REQUEST)) {
  ...
  echo '<p><a href="', $this->login_link(), '">Click here to try again, accept the terms this time!</a></p>';
  exit;
}

if (empty($_REQUEST['state']) || empty($_SESSION[DKOFBLOGIN_SLUG.'_state'])) {
  echo '<p>Missing state</p>';
  exit;
}
...
if (!$new_access_token) {
  header('location: ' . $this->login_link());
  exit;
}
